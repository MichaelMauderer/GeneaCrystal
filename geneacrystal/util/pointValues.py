...
BUBBLE_REMOVED_FROM_STRUCTURE = 1

def getPointsForDestroyedStructureElements(numberOfDestroyedElements):
    return (numberOfDestroyedElements**2) * BUBBLE_REMOVED_FROM_STRUCTURE